...
import com.Hospital.View.Receptionistview.AddPatient;
import com.Hospital.View.Receptionistview.RemovePatient;
...
public class Admin extends Employee{
	...
	private void assignInfo(){
		this.operations = Arrays.asList(new AddEmployee(),new AddPatient(),new ViewEmployees(),new ViewPatients(),new EditEmployee(),new FireEmployee(),new RemovePatient(),new LogOut());
	}
