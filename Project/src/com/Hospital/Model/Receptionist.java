...
import com.Hospital.View.DoctorView.CancelAppointment;
...
public class Receptionist extends Employee{
    ...
    private void assignInfo(){
        this.operations = Arrays.asList(new AddPatient(),new AddAppointment() , new ViewDoctors(),new ViewAvailableDoctors(),new RemovePatient(),new ViewAppointments(),new CancelAppointment(),new LogOut());
    }
