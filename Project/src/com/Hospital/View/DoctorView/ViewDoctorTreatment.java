...
import com.Hospital.Controller.DoctorController.GetDoctorTreatment;
...
public class ViewDoctorTreatment implements Operations {
    ...
    public void operation(User user) {
        ...
        ArrayList<Treatment> treatments  = new GetDoctorTreatment().getTreatments(patientId, SignIn.getInstance().getUser().getId());
